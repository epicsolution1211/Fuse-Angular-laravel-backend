...
export class AddSubscriptionComponent implements OnInit {
     ...
     */
    constructor(
        public matDialogRef: MatDialogRef<AddSubscriptionComponent>,
    ...
    save(): void
    {
        ...
        if(this.form.valid){
            ...
            const licence_id = this.licence_id;
            this.loggedin_id = user.id;
            const formData = new FormData();
            if(this.form.value.leaseplan){
                formData.append("leaseplan",this.form.get("leaseplan").value);
            ...
            this.isLoading = true;
            this.commonService.addSubscription(formData).subscribe(data => {
