...
import { AddLicencePermanentComponent } from './add-licence/add-licence-permanent.component';
import { ConfirmationDialog } from 'app/shared/components/confirmation-dialog/confirmation-dialog.component';
import { ToastrService } from 'ngx-toastr';
import { Router } from '@angular/router';

@Component({
  selector: 'app-licences-permanent',
  templateUrl: './licences-permanent.component.html',
  styleUrls: ['./licences-permanent.component.scss']
})
export class LicencesPermanentComponent implements OnInit {
  ...
  openLicenceComposeDialog(): void {
    // Open the dialog
    const dialogRef = this._matDialog.open(AddLicencePermanentComponent, {
      width: '1000px',
