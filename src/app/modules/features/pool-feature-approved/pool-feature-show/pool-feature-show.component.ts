...
@Component({
  selector: 'app-pool-feature-show',
  templateUrl: './pool-feature-show.component.html',
  styleUrls: ['./pool-feature-show.component.scss']
})
export class PoolFeatureShowComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.data = this.commonService.getPoolFeatureData;

    // console.log(">>>>>>>>>>>>>>>>>>>>>>>>>", this.data)
    if (this.data == undefined) {
      this._router.navigateByUrl('/feature_pool')
    }
