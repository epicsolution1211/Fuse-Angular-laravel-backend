...
@Component({
  selector: 'app-update-licence-assignee',
  templateUrl: './update-licence-assignee.component.html',
  styleUrls: ['./update-licence-assignee.component.scss']
})
export class UpdateLicenceAssigneeComponent implements OnInit {
    form: FormGroup;
    features: any;
    isLoading: boolean;
    submitted: boolean;
     ...
     */
    constructor(
        public matDialogRef: MatDialogRef<UpdateLicenceAssigneeComponent>,
    ...
    updateLicence(): void
    {
        ...
        if(this.form.valid){
            ...
            this.isLoading = true;
            this.commonService.updateLicence(formData).subscribe(data => {
