...
import { RoleGuard } from './core/auth/guards/role.gaurd';
...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children   : [
            // {path: 'roles', loadChildren: () => import('app/modules/ecommerce/ecommerce.module').then(m => m.ECommerceModule)},
            {path: 'tasks', loadChildren: () => import('app/modules/tasks/tasks.module').then(m => m.TasksModule)},
            {
                path: '',
                canActivate: [AuthGuard],
                canActivateChild: [AuthGuard],
                loadChildren: () => import('app/modules/features/features.module').then(m => m.FeaturesModule),
            },
            // {
            //     path: 'admin',
