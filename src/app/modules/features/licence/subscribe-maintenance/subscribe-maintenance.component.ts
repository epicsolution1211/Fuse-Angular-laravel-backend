...
@Component({
  selector: 'app-subscribe-maintenance',
  templateUrl: './subscribe-maintenance.component.html',
  styleUrls: ['./subscribe-maintenance.component.scss']
})
export class SubscribeMaintenanceComponent implements OnInit {
    form: FormGroup;
    features: any;
    isLoading: boolean;
    submitted: boolean;
     ...
     */
    constructor(
        public matDialogRef: MatDialogRef<SubscribeMaintenanceComponent>,
    ...
    subscriptionMaintenance(): void
    {
        ...
        if(this.form.valid){
            ...
            this.isLoading = true;
            this.commonService.subscriptionMaintenance(formData).subscribe(data => {
