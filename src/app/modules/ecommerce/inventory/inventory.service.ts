...
import { InventoryBrand, InventoryCategory, InventoryPagination, InventoryProduct, InventoryTag, InventoryVendor } from '../inventory/inventory.types';
...
export class InventoryService
{
    ...
    getTaskById(id: string): Observable<InventoryProduct>
    {
        return this._products.pipe(
            take(1),
            map((tasks) => {
